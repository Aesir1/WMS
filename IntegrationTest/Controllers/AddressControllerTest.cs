...
{   
    ...
    public void GetOnSuccessAddressWithId()
    {
        ...
        AddressController addressController = new AddressController(context);
        // Act
    ...
    public void CreateOnSuccessAddress()
    {
        ...
        AddressController addressController = new AddressController(context);
        // Act
        var result = addressController.CreateAddress(AddressFixture.CodeId, description: AddressFixture.Description).Result;
        // Assert
    ...
    public void DeleteAddressOnFail()
    {
        ...
        // Assert
        result.ShouldBeOfType<ObjectResult>().StatusCode.ShouldBe(304); 
        resultFromResult.Value.ShouldBeOfType<Exception>().Message.ShouldBe($"Address id doesn't exists:{AddressFixture.CodeId}");
    }
}